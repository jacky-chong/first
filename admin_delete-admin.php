...
<div class="center">
             <form action="" method="post">
               <table style="width: 100%">
                 <tr>
                   <td class="title" style="text-align:center;background:#fff; font-size:4em;font-family: 'Pacifico', cursive;">Select Admin</td>
                   </tr>
               </table>
             	<table style="width: 100%">
          ...
          <?php
			  			...
			  			{
			  				$result = mysqli_query($con,"SELECT * FROM admin WHERE Admin_Username LIKE '%" . $search . "%'");
			  			}
					?>
          ...
          <form action="Delete_user.php" method="post">
            ...
            <tr>
              <td></td>
              <td align="center" class="center"><div style="align" class="my">
              <?php
              //get the number of rows fetched
              while($row = mysqli_fetch_array($result))
              {
                echo "<input type='checkbox' name='no[]' id='" . $row['Admin_Username'] . "' value='".$row['AdminID']."'>";
                echo "<label class='bg-color' for='" . $row['Admin_Username'] . "'>" . $row['Admin_Username'] . "</label></br>";
              }
