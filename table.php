<!DOCTYPE html>
    ...
    <body>
     ...
     session_start();
        ...
        <nav>
            <ul class="nav_links1">
                <li><a href="table.php?scf=1">Science Fiction</a></li>
                <li><a href="table.php?scf=2">Thriller</a></li>
                <li><a href="table.php?scf=3">Fantasy</a></li>
                <li><a href="table.php?scf=7">Biography</a></li>
                <li><a href="table.php?scf=8">Comic & Graphic Novel</a></li>
                <li><a href="table.php?scf=9">Dective & Mystery</a></li>
                <li><a href="table.php?scf=10">Romance</a></li>
                <li><a href="table.php?scf=11">Action & Aventure</a></li>
                <li><a href="table.php?scf=12">Classics</a></li>
                <li><a href="table.php?scf=13">Essays</a></li>
            </ul>
        </nav>
        </div>
        <?PHP
        ...
        if($host == '/first/table.php?scf=1'){
           $sc = "=1";
        }
        elseif($host == '/first/table.php?scf=2'){
            $sc = "=2";
         }
         elseif($host == '/first/table.php?scf=3'){
            $sc = "=3";
         }
         elseif($host == '/first/table.php?scf=7'){
            $sc = "=7";
         }
         elseif($host == '/first/table.php?scf=8'){
            $sc = "=8";
         }
         elseif($host == '/first/table.php?scf=9'){
            $sc = "=9";
         }
         elseif($host == '/first/table.php?scf=10'){
            $sc = "=10";
         }
         elseif($host == '/first/table.php?scf=11'){
            $sc = "=11";
         }
         elseif($host == '/first/table.php?scf=12'){
            $sc = "=12";
         }
         elseif($host == '/first/table.php?scf=13'){
            $sc = "=13";
         }
        else
        {
...
$result = $mysqli->query
("select *from reading_material join book_gen on reading_material.RmID = book_gen.RmID where book_gen.CategoryID $sc group by reading_material.RmID")
or die($mysqli->error);
