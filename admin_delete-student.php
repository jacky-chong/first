...
<div class="center">
             <form action="" method="post">
               <table style="width: 100%">
                 <tr>
                   <td class="title" style="text-align:center;background:#fff; font-size:4em;font-family: 'Pacifico', cursive;">Select Student</td>
                   </tr>
               </table>
          ...
          <form action="Delete_user.php" method="post">
            ...
            <tr>
              ...
              {
                echo "<input type='checkbox' name='no[]' id='" . $row['StudentID'] . "' value='".$row['StudentID']."'>";
                echo "<label class='bg-color' for='" . $row['Username'] . "'>" . $row['Username'] . "</label></br>";
              }
