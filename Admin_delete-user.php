...
<div class="center">
             <table style="width: 100%">
              <tr>
                <td style="padding: 20px;"><a style="font-size:20px;padding: 0.5rem 33px;" class="button" href="admin_delete-admin.php">Delete Account Admin</a></td>
             </tr>
              <tr>
                <td style="padding: 20px;"><a style="font-size:20px;padding: 0.5rem 20px;" class="button" href="admin_delete-librarian.php">Delete Account Librarian</a></td>
             </tr>
              <tr>
                <td style="padding: 20px;"><a style="font-size:20px;padding: 0.5rem 25px;" class="button" href="admin_delete-student.php">Delete Account Student</a></button></td>
             </tr>
